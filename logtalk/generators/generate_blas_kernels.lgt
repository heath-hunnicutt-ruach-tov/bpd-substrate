:- object(generate_blas_kernels).

    :- public(test/0).

    :- uses(c_ast, [emit_program/2, emit_c/2]).
    :- uses(kernel_templates_blas, [sgemv_kernel_cublas_match/2, sgemv_wrapper_cublas_match/2, sgemv_kernel_substrate_native/2, sgemv_wrapper_substrate_native/2]).
