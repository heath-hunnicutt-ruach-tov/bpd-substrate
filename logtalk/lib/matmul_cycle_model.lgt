:- protocol(matmul_cycle_modelp).
    :- public(predict_matmul/5).
    :- public(predict_gflops/5).
    :- public(compare_configs/4).
:- end_protocol.

:- object(matmul_cycle_model,
    implements(matmul_cycle_modelp)).
