:- protocol(kernel_templates_llamap).
    :- public(vecmat_kernel/1).
    :- public(vecmat_wrapper/1).
    :- public(rms_norm_kernel/1).
    :- public(rms_norm_wrapper/1).
    :- public(warp_reduce_sum_helper/1).
    :- public(warp_reduce_max_helper/1).
    :- public(block_reduce_sum_helper/1).
    :- public(block_reduce_max_helper/1).
    :- public(softmax_kernel/1).
    :- public(softmax_kernel/2).
    :- public(softmax_wrapper/1).
    :- public(kernel_available_fixes/2).
    :- public(fix_description/2).
    :- public(binary_elem_kernel/3).
    :- public(binary_wrapper/3).
    :- public(unary_activation_kernel/2).
    :- public(unary_activation_wrapper/3).
    :- public(silu_kernel/1).
    :- public(silu_wrapper/1).
    :- public(rope_kernel/1).
    :- public(rope_wrapper/1).
    :- public(rope_k_wrapper/1).
    :- public(embed_kernel/1).
    :- public(embed_wrapper/1).
    :- public(causal_mask_kernel/1).
    :- public(causal_mask_wrapper/1).
    :- public(matmul_kernel/1).
    :- public(matmul_kernel/2).
    :- public(matmul_wrapper/1).
    :- public(matmul_wrapper/2).
    :- public(matmul_opt_wrapper/1).
    :- public(matmul_opt_wrapper/2).
    :- public(layer_norm_kernel/1).
    :- public(layer_norm_wrapper/1).
    :- public(activation_expr/3).
:- end_protocol.

:- object(kernel_templates_llama,
    implements(kernel_templates_llamap)).
