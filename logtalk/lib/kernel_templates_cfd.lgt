:- protocol(kernel_templates_cfdp).
    :- public(stencil_expr/4).
    :- public(cfd_kernel_signature/2).
    :- public(cfd_flux_kernel/2).
    :- public(cfd_flux_wrapper/2).
    :- public(cfd_update_conservative_kernel/2).
    :- public(cfd_update_conservative_wrapper/2).
    :- public(cfd_compute_primitives_kernel/2).
    :- public(cfd_compute_primitives_wrapper/2).
    :- public(cfd_cfl_condition_kernel/2).
    :- public(cfd_cfl_condition_wrapper/2).
    :- public(kernel_available_fixes/2).
    :- public(fix_description/2).
:- end_protocol.

:- object(kernel_templates_cfd,
    implements(kernel_templates_cfdp)).
