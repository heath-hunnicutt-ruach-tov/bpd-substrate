:- protocol(matmul_optimizerp).
    :- public(valid_config/1).
    :- public(config_metrics/2).
    :- public(best_configs/2).
    :- public(print_configs/1).
    :- public(config_metrics_v2/2).
    :- public(valid_pipeline_config/1).
    :- public(pipeline_config_metrics/2).
    :- public(reduction_strategy_kind/1).
    :- public(k_tile_strategy_kind/1).
    :- public(k_tile_strategy_description/2).
    :- public(k_tile_for_shape/5).
:- end_protocol.
